...
namespace Analytics.Helpers.BO
{
    ...
    public class DataInsertionBO
    {
        ...
        public void InsertShortUrldata(string ipv4, string ipv6, string ipnum, string browser, string browser_version,string latitude,string longitude, string req_url, string useragent, string hostname, string ismobiledevice, int? fk_uid, int? fk_rid, int? FK_clientid)
        {
            SqlConnection lSQLConn = null;
            SqlCommand lSQLCmd = new SqlCommand();
            string connStr = "";
